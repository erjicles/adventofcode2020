...
namespace AdventOfCode2020.Challenges.Day25
{
    public static class Day25
    {
        ...
        public static BigInteger GetDay25Part01Answer()
        {
            /*
...
What encryption key is the handshake trying to establish?
            */
            // Answer: 19414467
            var publicKeys = GetDay25Input();
            var encryptionKey = DoorHelper.GetEncryptionKey(publicKeys.Item1, publicKeys.Item2);
            return encryptionKey;
        }

        public static BigInteger GetDay25Part02Answer()
        {
            /*
            */
            // Answer: 
        ...
        private static Tuple<BigInteger, BigInteger> GetDay25Input()
        {
            ...
            var result = new Tuple<BigInteger, BigInteger>(
