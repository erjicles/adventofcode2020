...
namespace AdventOfCode2020.Challenges.Day13
{
    public static class Day13
    {
        ...
        public static int GetDay13Part01Answer()
        {
            ...
            // Answer: 3215
            var busData = GetDay13Input();
            var busIdWithLowestWaitTime = BusHelper.GetBusIdWithLowestWaitTime(busData);
            var result = busIdWithLowestWaitTime.Item1 * busIdWithLowestWaitTime.Item2;
            return result;
        }
        ...
        public static BigInteger GetDay13Part02Answer()
        {
            ...
            // Answer: 1001569619313439
            var busData = GetDay13Input();
            var result = BusHelper.GetEarliestValidTimestamp(busData.Item2);
            return result;
        }
