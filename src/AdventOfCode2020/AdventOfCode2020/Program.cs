...
namespace AdventOfCode2020
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Day 4
            Console.WriteLine($"Day 04 - Part 1: {Day04.GetDay04Part01Answer()}");
            ...
            // Day 6
            Console.WriteLine($"Day 06 - Part 1: {Day06.GetDay06Part01Answer()}");
            Console.WriteLine($"Day 06 - Part 2: {Day06.GetDay06Part02Answer()}");
            // Day 7
            Console.WriteLine($"Day 07 - Part 1: {Day07.GetDay07Part01Answer()}");
            Console.WriteLine($"Day 07 - Part 2: {Day07.GetDay07Part02Answer()}");
            // Day 8
            Console.WriteLine($"Day 08 - Part 1: {Day08.GetDay08Part01Answer()}");
            Console.WriteLine($"Day 08 - Part 2: {Day08.GetDay08Part02Answer()}");
            // Day 9
            Console.WriteLine($"Day 09 - Part 1: {Day09.GetDay09Part01Answer()}");
            Console.WriteLine($"Day 09 - Part 2: {Day09.GetDay09Part02Answer()}");
            // Day 10
            ...
            Console.WriteLine($"Day 11 - Part 2: {Day11.GetDay11Part02Answer()}");
            // Day 12
            Console.WriteLine($"Day 12 - Part 1: {Day12.GetDay12Part01Answer()}");
            Console.WriteLine($"Day 12 - Part 2: {Day12.GetDay12Part02Answer()}");
            // Day 13
            Console.WriteLine($"Day 13 - Part 1: {Day13.GetDay13Part01Answer()}");
            Console.WriteLine($"Day 13 - Part 2: {Day13.GetDay13Part02Answer()}");
            // Day 14
            Console.WriteLine($"Day 14 - Part 1: {Day14.GetDay14Part01Answer()}");
            Console.WriteLine($"Day 14 - Part 2: {Day14.GetDay14Part02Answer()}");
            // Day 15
            Console.WriteLine($"Day 15 - Part 1: {Day15.GetDay15Part01Answer()}");
            ...
            // Day 17
            Console.WriteLine($"Day 17 - Part 1: {Day17.GetDay17Part01Answer()}");
            Console.WriteLine($"Day 17 - Part 2: {Day17.GetDay17Part02Answer()}");
            // Day 18
            Console.WriteLine($"Day 18 - Part 1: {Day18.GetDay18Part01Answer()}");
            Console.WriteLine($"Day 18 - Part 2: {Day18.GetDay18Part02Answer()}");
            // Day 19
            Console.WriteLine($"Day 19 - Part 1: {Day19.GetDay19Part01Answer()}");
            Console.WriteLine($"Day 19 - Part 2: {Day19.GetDay19Part02Answer()}");
            // Day 20
            Console.WriteLine($"Day 20 - Part 1: {Day20.GetDay20Part01Answer()}");
            ...
            // Day 22
            Console.WriteLine($"Day 22 - Part 1: {Day22.GetDay22Part01Answer()}");
            Console.WriteLine($"Day 22 - Part 2: {Day22.GetDay22Part02Answer()}");
            // Day 23
            Console.WriteLine($"Day 23 - Part 1: {Day23.GetDay23Part01Answer()}");
            Console.WriteLine($"Day 23 - Part 2: {Day23.GetDay23Part02Answer()}");
            // Day 24
            Console.WriteLine($"Day 24 - Part 1: {Day24.GetDay24Part01Answer()}");
            Console.WriteLine($"Day 24 - Part 2: {Day24.GetDay24Part02Answer()}");
            // Day 25
            Console.WriteLine($"Day 25 - Part 1: {Day25.GetDay25Part01Answer()}");
            var endTime = DateTime.Now;
            Console.WriteLine("All puzzles complete! You have now arrived at your sweet tropical vacation spot. Enjoy!");
            Console.WriteLine($"Processing complete in {(endTime - startTime).TotalSeconds} second(s)!");
        }
    }
}
