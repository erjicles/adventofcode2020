...
namespace AdventOfCode2020Test.Challenges
{
    public class Day20Test
    {
        ...
        [Fact]
        public void GetImageFromTilePlacementStringsTest()
        {
            var testData = new List<Tuple<IList<IList<IList<string>>>, int, IList<string>>>()
            {
                new Tuple<IList<IList<IList<string>>>, int, IList<string>>(
            ...
            foreach (var testExample in testData)
            {
                var actual = SatelliteImageHelper.GetImageFromTilePlacementStrings(testExample.Item1, testExample.Item2);
                Assert.Equal(testExample.Item3, actual);
            }
        }
        
        [Fact]
        public void GetRoughWaterPositionsTest()
        {
            var testData = new List<Tuple<IList<string>, IList<string>, char, int>>()
            {
                new Tuple<IList<string>, IList<string>, char, int>(
                    new List<string>()
                    {
                        ".#.#..#.##...#.##..#####",
                        "###....#.#....#..#......",
            ...
            foreach (var testExample in testData)
            {
                var roughWaterPositions = SatelliteImageHelper.GetRoughWaterPositions(testExample.Item1, testExample.Item2, testExample.Item3);
                var actual = roughWaterPositions.Count;
        ...
        [Fact]
        public void GetDay20Part02AnswerTest()
        {
            long expected = 2161;
            long actual = Day20.GetDay20Part02Answer();
            Assert.Equal(expected, actual);
        }
    }
}
